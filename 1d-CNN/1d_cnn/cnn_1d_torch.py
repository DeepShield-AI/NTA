...
def main():
    ...
    # 导入数据
    folder_path_list=[
        r"/home/liz/test/Algorithm/1d-CNN/data/12class/FlowAllLayers",
        r"/home/liz/test/Algorithm/1d-CNN/data/12class/FlowL7",
        r"/home/liz/test/Algorithm/1d-CNN/data/12class/SessionAllLayers",
        r"/home/liz/test/Algorithm/1d-CNN/data/12class/SessionL7",
                      ]
